...
function TacticalImporter({lang,exercises,setExercises,setPage}){
 ...
 return <div className="tacticalImporter">
  <section className="card importHero"><div><small>V20 · VERSÃO DE UTILIZAÇÃO · LOCAL / OFFLINE</small><h2>{t.title}</h2><p>PDF · PowerPoint · Vídeo · Foto / esquema manuscrito → animação editável → Biblioteca</p></div><ScanSearch size={46}/></section>
